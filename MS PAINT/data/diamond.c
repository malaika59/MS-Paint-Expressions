...
void hollowdiamond(int size, int outlinecolorChoice, char symbol, int position)
{
    FILE *mal;
...
void diamond(int size, int outlinecolorChoice, int fillcolorChoice, char symbol, int position)
{
    FILE *mal;
    mal = fopen("C:\\Users\\Muhammad Saad\\Desktop\\MALAIKA GROUP-PF PROJECT\\temp\\mal.txt", "w"); // hr function k uper
