...
void rectangle(int row, int col, char symbol, int position, int outlinecolor, int fillcolor)
{FILE*m;
...
void hollow_rectangle(int row, int col, char symbol, int position, int outlinecolor)
{FILE*m;
    m=fopen("C:\\Users\\Muhammad Saad\\Desktop\\MALAIKA GROUP-PF PROJECT\\temp\\mal.txt","w");//hr function k uper
